              ...
              <div className="flex h-full flex-col">
                ...
                <ScrollArea className="h-0 flex-1 [&_[data-radix-scroll-area-viewport]>:first-child]:block!">
                  ...
                  <div className="flex w-full flex-1 flex-col">
                    ...
                    <div className={`group/project hover:bg-primary/5 relative`}>
                      ...
                      <div className="transition-all duration-200 group-hover/project:pl-8">
                        <div className="hover:bg-primary/5 flex w-full cursor-pointer items-center gap-4 p-3 text-left transition-colors duration-200">
                          <div className="flex w-full flex-1 items-center gap-3">
                            <SiLaravel className="h-8 w-8 text-[#FF2D20]" />
                            <div className="w-full truncate">
                              <div className="flex items-center justify-between gap-2">
                                ...
                                <div className="flex items-center gap-1.5">
                                  <HiOutlineStatusOnline className="text-muted-foreground/40 h-3.5 w-3.5 shrink-0" />
                                </div>
                              </div>
                    ...
                    {/* Another Project Item */}
                    <div className={`group/project bg-primary/5 relative`}>
                      <div className="bg-primary/5 absolute top-0 left-0 flex h-full w-0 cursor-grab items-center justify-center overflow-hidden opacity-0 transition-all duration-200 group-hover/project:w-8 group-hover/project:opacity-100 active:cursor-grabbing">
                        <GripVertical className="text-muted-foreground h-4 w-4" />
                      </div>
                      <div className="transition-all duration-200 group-hover/project:pl-8">
                    ...
                    <div className={`group/project hover:bg-primary/5 relative`}>
                      ...
                      <div className="transition-all duration-200 group-hover/project:pl-8">
                        <div className="hover:bg-primary/5 flex w-full cursor-pointer items-center gap-4 p-3 text-left transition-colors duration-200">
                          <div className="flex w-full flex-1 items-center gap-3">
                            <SiPhp className="h-8 w-8 text-[#777BB4]" />
                            <div className="w-full truncate">
                              <div className="flex items-center justify-between gap-2">
                                <span className="truncate text-sm font-semibold capitalize">
                                  Checkoutdemo
                              ...
                              <p className="text-muted-foreground flex items-center gap-1 text-xs">
                                <FaLink className="h-3 w-3 shrink-0" />
                                <span className="truncate">checkoutdemo.local</span>
                              </p>
                            </div>
                          </div>
                        </div>
                ...
                <div className="flex h-full flex-col">
                  <ScrollArea className="h-1/2 min-h-1/2 transition-all [&_[data-radix-scroll-area-viewport]>:first-child]:h-full">
                    <div className="flex h-full flex-1 flex-col space-y-4 p-2">
                      ...
                      {/* Browser Preview */}
                      <div className="h-36 max-h-max overflow-hidden rounded duration-700 hover:h-90 hover:transition-[height] hover:duration-800">
                        <div className="relative mx-auto w-full max-w-2xl">
                          ...
                          <div className="pointer-event-none absolute inset-0 top-[6.9%] right-[0.08%] bottom-[1.6%] left-[0.08%] overflow-hidden">
                            <div className="h-full w-full overflow-hidden">
                              <div className="flex h-[400%] min-h-screen w-[400%] origin-top-left scale-[0.25] flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
                                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                                  <div className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                                    <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                                      <h1 className="mb-1 font-medium">Let&rsquo;s get started</h1>
                                        ...
                                        <li className="relative flex items-center gap-4 py-2 before:absolute before:top-1/2 before:bottom-0 before:left-[0.4rem] before:border-l before:border-[#e3e3e0] dark:before:border-[#3E3E3A]">
                                          <span className="relative bg-white py-1 dark:bg-[#161615]">
                                            <span className="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-[#e3e3e0] bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-[#3E3E3A] dark:bg-[#161615]">
                                              <span className="h-1.5 w-1.5 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]"></span>
                                            </span>
                                          </span>
                                          <span>
                                            Read the
                      ...
                      <div className="z-10 -mt-7 mb-0 flex items-baseline justify-between px-2">
                        <div className="bg-background z-10 flex items-center p-2 dark:bg-black">
                          <SiLaravel className="h-11 w-11 text-[#FF2D20]" />
                        </div>
                      ...
                      <div className="flex items-start justify-between px-2">
                        <div className="flex-1">
                          <h2 className="text-2xl font-bold capitalize">Laravel</h2>
                        </div>
                      </div>
                      ...
                      <div className="flex flex-col gap-4 px-2">
                        ...
                        <Tabs
                          ...
                          className="flex w-full flex-col gap-4 rounded-none px-2"
                        >
                          <TabsList className="bg-muted text-muted-foreground inline-flex h-8 w-full items-center justify-center rounded-none p-[3px]">
                            <TabsTrigger
                              value="actions"
                          ...
                          <TabsContent value="actions" className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-col gap-3">
                              <div className="grid grid-cols-2 gap-3">
                                <Button variant="outline" className="h-8.5 gap-1.5 rounded-none">
                              ...
                              <Button className="h-8.5 gap-1.5 rounded-none bg-[#007ACC] text-white hover:bg-[#005A9E]">
                          ...
                          <TabsContent value="ngrok" className="flex flex-col gap-4"></TabsContent>
                        </Tabs>
                      </div>
                    </div>
                  </ScrollArea>
