...
<Callout type="tip">Run PHP 7.4 and 8.4 simultaneously with different projects.</Callout>
...
<Callout type="success">
  Toggle the switch during creation - DAMP handles the DevContainer configuration.
</Callout>
...
<Callout type="tip">Create a Basic PHP project to verify your setup before trying Laravel.</Callout>
