...
<Callout type="warning">
  When creating or deleting sites, you'll see a UAC (User Account Control) prompt. This is normal -
  DAMP needs administrator permission to modify the hosts file.
</Callout>
...
<Callout type="info">
  Custom domain configuration is coming in a future update. Currently, all projects use `.local` by
  default.
</Callout>
...
<Callout type="success">DAMP handles all domain management automatically.</Callout>

## Troubleshooting

<Accordions type="single">
  <Accordion title="Domain Not Resolving">
    <b>Problem:</b> Can't access <code>myapp.local</code> after creating project
    <br />
    <br />
    <b>Solutions:</b>
    <ol>
      ...
      <li>
        Try flushing DNS cache: <code>ipconfig /flushdns</code>
      </li>
      <li>
        Check Windows hosts file for entry: <code>C:\Windows\System32\drivers\etc\hosts</code>
      </li>
    </ol>
  </Accordion>
  <Accordion title="UAC Prompt Issues">
    <b>Problem:</b> UAC prompt doesn't appear or fails
    <br />
    <br />
    <b>Solutions:</b>
    <ol>
  ...
  <Accordion title="Chrome Not Loading Domain">
    <b>Problem:</b> Chrome shows "This site can't be reached"
    <br />
    <br />
    <b>Solutions:</b>
    <ol>
...
<Callout type="info">
  If you're experiencing domain resolution issues, check the DAMP troubleshooting guide or open an
  issue on GitHub.
</Callout>
