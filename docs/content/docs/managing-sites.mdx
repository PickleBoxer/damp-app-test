...
<Callout type="tip">This launches your project in VS Code without folder browsing.</Callout>
...
<Callout type="info">
  See the complete [Volume Sync Guide](/docs/volume-sync) for details on performance, sync timing,
  and troubleshooting.
</Callout>
