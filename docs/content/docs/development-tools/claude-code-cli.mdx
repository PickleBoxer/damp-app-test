...
<Callout type="success">
  Enable Claude Code CLI during project creation - it's automatically installed and configured in
  your devcontainer with zero manual setup.
</Callout>
...
<Callout type="info">
  The feature is added during project creation and installed when the devcontainer builds. No manual
...
<Callout type="warning">
  - Claude Code CLI sends code to Anthropic's API for processing - Code is analyzed to provide
  relevant suggestions - Don't use with sensitive/proprietary code without reviewing terms -
...
<Accordions type="single">
  <Accordion title="Claude Command Not Found">
    <b>Problem:</b> <code>claude: command not found</code>
    <br />
    <br />
    <b>Solution:</b> Ensure feature is added to <code>devcontainer.json</code> and container is
    rebuilt.
  </Accordion>
  <Accordion title="Authentication Failed">
    <b>Problem:</b> Can't authenticate with API key
    <br />
    <br />
    <b>Solutions:</b>
    <ol>
      ...
      <li>
        Try re-authenticating: <code>claude --logout</code> then <code>claude</code>
      </li>
    </ol>
  </Accordion>
  <Accordion title="Slow Responses">
    <b>Problem:</b> Claude takes long to respond
    <br />
    <br />
    <b>Solutions:</b>
    <ol>
...
<Callout type="success">
  Enable Claude Code CLI with one click and experience AI-assisted coding directly in your
  devcontainer.
</Callout>
