...
<Callout type="success">
  Start a secure tunnel for any project with one click and get a public URL to share with clients,
  teammates, or for testing webhooks.
</Callout>
...
<Callout type="info">
  **Free vs Paid Plans** - **Free**: 1 tunnel, ngrok subdomain, 40 connections/minute - **Paid**:
  Custom domains, more tunnels, higher limits
</Callout>
...
<Callout type="warning">
  Your project must be running in VS Code's devcontainer before starting a tunnel. The tunnel
  connects to your devcontainer's web server.
</Callout>
...
<Callout type="warning">
  - Tunnels expose your local environment to the internet - Anyone with the URL can access your site
  - Use .env protection for sensitive data - Don't share tunnel URLs publicly unless intended
</Callout>
...
<Accordions type="single">
  <Accordion title="Tunnel Won't Start">
    <b>Problem:</b> "Devcontainer is not running"
    <br />
    <br />
    <b>Solution:</b> Open your project in VS Code and reopen in container first.
    <br />
    <br />
    <b>Problem:</b> "Authtoken not configured"
    <br />
    <br />
    <b>Solution:</b> Add your ngrok authtoken in Settings → Ngrok Tunneling.
    <br />
    <br />
    <b>Problem:</b> "Tunnel already running"
    <br />
    <br />
    <b>Solution:</b> Stop the existing tunnel before starting a new one.
  </Accordion>
  <Accordion title="Can't Access Tunnel URL">
    <b>Problem:</b> Tunnel URL returns 502 Bad Gateway
    <br />
    <br />
    <b>Solutions:</b>
    <ol>
      ...
      <li>
        Check that your application is listening on <code>0.0.0.0</code> (not <code>localhost</code>
        )
      </li>
